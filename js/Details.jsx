...
const mapDispactchToProps = (dispactch: Function, ownProps) => ({
  getAPIData() {
    dispactch(getAPIDetails(ownProps.show.imdbID));
  }
});

export default connect(mapStateToProps, mapDispactchToProps)(Details);
