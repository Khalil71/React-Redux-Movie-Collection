...
import Search, { Unwarapped as UnwarappedSearch } from '../Search';
import ShowCard from '../ShowCard';

test('Search renders correctly', () => {
  const component = shallow(<UnwarappedSearch shows={preload.shows} searchTerm="" />);
...
test('Search should render correct amount of shows based on search term - without-Redux', () => {
  ...
  const component = shallow(<UnwarappedSearch shows={preload.shows} searchTerm={searchWord} />);
